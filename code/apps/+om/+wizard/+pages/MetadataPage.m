classdef MetadataPage < wizard.abstract.Page

    properties (Constant)
        Name = 'Dataset'
        Title = "Initialize metadata product"
        Description = "Specify a short name and a folder to save metadata"
    end
    ...
    methods (Access = protected)
        ...
        function createComponents(obj)
            ...
            obj.DatasetWidgets = om.wizard.pages.component.Metadata(obj.GridLayout);
