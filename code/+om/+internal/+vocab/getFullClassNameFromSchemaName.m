...
function D = buildFullClassNameMap()
    ...
    relativeFilePaths = recursiveDir(schemaPath, 'FileType', 'm', "IgnoreList", "Contents", "OutputType", "RelativeFilePath");
...
function throwSchemaNotFoundError(schemaName)
    error('OPENMINDS_UI:SchemaNameNotFound', 'No schema name matching "%s" was found.', schemaName);
end