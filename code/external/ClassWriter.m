...
%       subclasses in the class documentation.
    ...
    properties (Constant, Hidden)
        LineIndenter = memoize(@ClassWriter.getLineIndent)
    end
    ...
    methods (Static, Access = private)
        ...
        %getLineIndent Get spaces for indentation
            indentationWidth = numIndents * ClassWriter.INDENTATION_WIDTH;
    ...
    methods (Static, Access = protected)
        function str = cellArrayToTextString(cellArray)
            str = om.generator.utility.cellArrayToTextString(cellArray);
        end
    end
end